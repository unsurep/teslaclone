    ...
    return(
        <main>
           {/* Model Y */}
            ...
            {/* Power wall */}
            <div className="bg-cover bg-center bg-no-repeat h-screen" style={{ backgroundImage: "url('/images/wp.jpg')" }}>
                <div className=" items-center flex flex-col w-full pt-16">
            ...
            {/* Accessories */}
            <div className="bg-cover bg-center bg-no-repeat h-screen" style={{ backgroundImage: "url('/images/charger.jpg')" }}>
                <div className=" items-center flex flex-col w-full pt-16">
                    <div className="flex flex-col items-center gap-3">
            ...
            <div className="">
                <div className=" items-center flex flex-col w-full relative">
                    ...
                    <div className="">
                        <video src="/videos/teslav.mp4" width={0} height={0} alt='video' className="w-[100vw]" controls/>
                    </div>

                    <div className="absolute left-[1rem] bottom-[5rem] text-neutral-500 w-fit ">
                        <h1 className="text-sm font-bold text-white">We are Tesla</h1>
